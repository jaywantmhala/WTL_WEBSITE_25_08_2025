...
export default function ForgotPasswordPage() {
  ...
  const handleSendOTP = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('http://localhost:8085/auth/send-otp', {
        method: 'POST',
        headers: {
  ...
  const handleVerifyOTP = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('http://localhost:8085/auth/verify-otp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('http://localhost:8085/auth/reset-password', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
